			...
			<div class="span10">
				...
				<form id="form" action="add" method="post"
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-prepend input-append">
								<span class="add-on">￥</span> <input type="number"
									name="carinfo.price" step="0.01" min="15.00" max="600.00"
									id="price"> <span
									class="add-on">万元起</span>
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-prepend input-append">
								<input type="number" name="carinfo.stock" min="0" max="50"
									id="stock"> <span class="add-on">辆</span>
							</div>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<s:file id="upload" name="upload"/>请选择120*90px大小的jpg图片
						</div>
					</div>
